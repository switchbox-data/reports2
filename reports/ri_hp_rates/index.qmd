...
Despite this dramatic increase in the electric bill, the overall bill is drops by `r (1 - (post_hp_total_bill_gas / pre_hp_total_bill_gas)) |> scales::percent()` to `r post_hp_total_bill_gas |> scales::dollar(accuracy = 1)`.
