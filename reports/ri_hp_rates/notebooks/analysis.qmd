...
# Add LMI discounts
load_or_download("electric_lmi_thresholds", url_delivery_rates, path_to_cache, load_from_cache = FALSE)
load_or_download("gas_lmi_thresholds", url_delivery_rates, path_to_cache, load_from_cache = FALSE)
