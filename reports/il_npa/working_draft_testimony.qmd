...
To estimate the length of CI/DI gas main serving this block, we measure the length of the street centerlines running along its borders, on the assumption that one main runs beneath each street. Approximately `r round(sample_total_pipe, 2)` miles of street run along this block, as labeled in @fig-outline-87th.
