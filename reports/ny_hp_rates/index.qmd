...
## The glide path: when do heat pump costs arrive?

The heat pump rate proposed above reflects today's reality: heat pump customers are not driving grid investment, because the system has spare winter capacity. But that window is closing. NYISO's Gold Book 2025 forecasts rapid heat pump adoption over the next three decades — and with it, building electrification will push New York's winter peak above its summer peak by the late 2030s, a historic shift from a summer-peaking to a winter-peaking system.

:::{.column-page-inset-right}
{{< embed notebooks/gold_book_peaks.qmd#fig-nyca-electrified-housing-image >}}
:::

Before the crossover, summer is the binding peak — the season that determines how much generation capacity the system needs. In NYISO's baseline forecast, only **`{python} pct(gb.nyca_summer_peak_growth_be_share)`** of cumulative NYCA summer peak growth from 2025 through 2055 comes from building electrification. Most of the summer capacity cost increase comes from EVs, large loads, and organic demand growth.

After the crossover, winter becomes the binding peak, and the picture inverts. Building electrification is the dominant driver of winter peak growth — responsible for the majority of the capacity cost increase in every year after the system becomes winter-peaking.

But the costs don't wait for the crossover. Because grid planners build ahead — NYISO's Gold Book exists precisely so utilities can see this coming a decade out — capacity procurement to meet anticipated winter peaks would begin years before winter formally overtakes summer. That means customers could start paying for winter-driven capacity costs as early as the mid-2030s, even while the system is still nominally summer-peaking.

:::{.column-page-inset-right}
{{< embed notebooks/gold_book_peaks.qmd#fig-summer-growth-slices >}}
:::

The chart above decomposes the summer peak into its growth drivers. Building electrification is a thin slice — most summer growth comes from EVs, large loads, and organic demand. This is why, today, heat pump customers are not driving capacity investment.

:::{.column-page-inset-right}
{{< embed notebooks/gold_book_peaks.qmd#fig-combined-growth-slices >}}
:::

Now overlay the winter peak. In the early years, summer (faded tones) is taller — it's the binding peak. But building electrification drives winter growth so aggressively that by the late 2030s, winter overtakes summer. The dashed line traces the summer peak after it's been eclipsed.

:::{.column-page-inset-right}
{{< embed notebooks/gold_book_peaks.qmd#fig-binding-peak-yoy >}}
:::

The bar chart shows the year-over-year increase in the binding peak — the peak that actually determines how much generation capacity the system needs — decomposed by driver. Before the crossover, the bars are small and reflect summer growth, with building electrification contributing a modest share. After the crossover, the bars jump as winter becomes binding, and building electrification dominates. The spike at the crossover is real: it reflects years of winter growth that accumulated "behind" the summer peak and arrives as a capacity cost all at once when winter overtakes summer. In practice, planners would smooth this by procuring capacity ahead of the crossover — but the cost attribution holds.

The picture sharpens when we zoom in to individual utilities. Each utility's winter peak is decomposed into the same growth components, with the summer peak overlaid as a dashed orange line. A green dashed line marks the distribution-relevant crossover — the year winter demand (excluding large loads, which connect at substations rather than feeders) first exceeds the summer peak. A red dashed line marks the year that distribution headroom is exhausted, based on the Synapse Energy Economics (2024) assessment of each utility's spare distribution capacity.

:::{.column-page-inset-right}
{{< embed notebooks/gold_book_peaks.qmd#fig-season-growth >}}
:::

The per-utility charts reveal that the timing varies significantly across service territories. Some utilities exhaust their distribution headroom well before the winter-summer crossover — meaning heat-pump-driven distribution costs arrive years before the system formally becomes winter-peaking.

:::{.column-page-inset-right}
{{< embed notebooks/gold_book_peaks.qmd#fig-demand-components >}}
:::

This has a direct implication for rate design: the heat pump rate proposed in this report is a short-term fix. It corrects today's cross-subsidy, where heat pump customers overpay for delivery because the system has spare winter capacity. But as winter peaks approach and then exceed summer peaks, heat pump customers will increasingly be the ones *driving* grid investment — and keeping rates fair will mean reflecting that cost.

Rather than a cliff — where the rate abruptly shifts from a discount to a surcharge — the transition should follow a glide path. As building electrification's share of capacity costs grows, the rate should gradually converge from today's below-average delivery charge toward a cost-of-service rate that reflects heat pump customers' actual contribution to winter peak investment. The pace of that convergence depends on the pace of heat pump adoption and the performance of the equipment being installed.
...
::::: {.column-page-inset-right}
{{< embed notebooks/analysis.qmd#fig-tou-flex-kwh-shift >}}
:::::

::::: {.column-page-inset-right}
{{< embed notebooks/analysis.qmd#fig-tou-flex-bill-shift >}}
:::::
