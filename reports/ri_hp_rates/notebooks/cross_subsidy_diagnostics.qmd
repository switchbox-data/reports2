...
RUN_CONFIG = {
    "precalc_delivery": {
        "run_id": "20260217_170234_ri_rie_run_01_precalc_delivery_up00_y2025",
    ...
    "precalc_delivery_supply": {
        "run_id": "20260217_165709_ri_rie_run_02_precalc_delivery_supply_up00_y2025",
        "cambium_costs": _CAMBIUM_S3,
        "target_year": 2025,
...
run_dirs = {label: f"{RUN_BASE}/{cfg['run_id']}" for label, cfg in RUN_CONFIG.items()}
