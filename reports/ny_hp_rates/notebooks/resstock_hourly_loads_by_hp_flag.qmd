---
title: NY ResStock Hourly Loads by HP Flag (2024 AMY2018 Release 2)
format:
  html:
    page-layout: full
toc: true
...
This notebook plots NY ResStock hourly loads split by heat-pump status using a Polars lazy/streaming workflow.
...
UPGRADE = "00"
CUSTOMER_COUNT = 7_500_000
SAMPLE_BUILDINGS = 2_000
...
if SAMPLE_BUILDINGS and metadata_df.height > SAMPLE_BUILDINGS:
    metadata_df = metadata_df.sample(n=SAMPLE_BUILDINGS, seed=42)
sample_bldg_ids = metadata_df["bldg_id"].to_list()
...
base_loads_lf = (
    base_loads_lf
    .filter(pl.col("bldg_id").is_in(sample_bldg_ids))
...
print(f"Sample buildings: {metadata_df.height:,}")
