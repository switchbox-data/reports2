...
To follow along with this report, the reader needs to understand the electric utility Costs, Bills, and Rates. These concepts are introduced and explained in this section.

Utility customers pay Bills in order to cover the Utility's Costs, and these Bills are calculated using Rates.

Rates are simply the _prices_ charged by the utility, and they come in two flavors:
...
- Supply pays for energy and generation capacity costs (and a few other things)
- Delivery pays for transmission and distribution capacity costs (and a few other things)

## Fixed vs. volumetric rates

- Explain what volumetric charges are.

## Costs

Let's look at costs first.

- To receive electricity, companies need to build

Companies build power plants, transmission lines, and distribution lines to produce and deliver electricity to customers. They incur capital costs while doing so, and ultimately need to recoup these costs from customers—plus a profit margin. Examples of these capital costs are shown in the table below.

In addition to these costs they incur when building this infrastructure, these companies also incur operating costs to operate and maintain their infrastructure, and run their business. Examples of these capital and operating costs are shown in the table below.
...
The operating costs of traditional fossil-fueled power plants go by a special name: **energy costs**, or each plant's cost of producing an additional kWh of electricity moment to moment. This is largely the cost of the fuel they burn to produce it, and a few other consummables.[^renewables]
...
- when they sign up, they get a meter, a service line, and start getting meter readings and bills. In other words, they cause distribution capital costs (connection) and variable operating costs.
- when they consume electricity, they cause energy costs.
- they also MIGHT cause new capital costs for transmission and distribution capacity, if they consume during hours when that capacity is strained, and they contribute to needing to build more of it.
- mostly, though, they just benefit from the existing infrastructure. they need to help pay for it somehow, and also for all of the fixed operating and maintenance costs of the infrastructure—repairing it, fixing trees, etc.
