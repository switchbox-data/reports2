...
| `lib.rates_analysis.fair_default`     | Closed-form fair-default rate design (Strategy A: `fixed_charge_only`). Uses the V^0-based Cramer formula — correct for seasonal/TOU baselines — to compute the revenue-neutral fixed charge that eliminates subclass delivery cross-subsidy. `fair_default_fixed_charge_only()` takes weighted aggregate totals (revenue, customer count, cross-subsidy, base fixed charge) and returns a `FairDefaultResult` with F\*, Δ, λ\*, and feasibility.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
