...
library(here)
here::i_am("reports/il_lea/notebooks/data_cleaning.qmd")
```
...
```{r}
if (!dir.exists(here("reports", "il_lea", "data_clean"))) dir.create(here("reports", "il_lea", "data_clean"), recursive = TRUE)

df_all |>
  write_csv(here("reports", "il_lea", "data_clean", "il_lea_data.csv"))
```
