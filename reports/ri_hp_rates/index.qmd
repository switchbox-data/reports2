...
Despite this dramatic increase in the electric bill, the overall bill drops by `r (1 - (post_hp_total_bill_gas / pre_hp_total_bill_gas)) |> scales::percent()` to `r post_hp_total_bill_gas |> scales::dollar(accuracy = 1)`.
...
As expected, the same seasonal pattern holds, with wintertime gas use now converted to electricity. During the eight months of the heating season, the heat pump home has lower bills every month but January, which drives the annual energy bill savings compared to the natural gas home.
