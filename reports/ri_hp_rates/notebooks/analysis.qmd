...
```{r}
#| label: sample home bills

monthly_bills_elec_x_upgrade_0 <- monthly_bills_elec |>
  filter(bldg_id == bldg_id_x) |>
  filter(upgrade == 0) |>
  filter(version == "baseline")

monthly_bills_elec_x_upgrade_2 <- monthly_bills_elec |>
  filter(bldg_id == bldg_id_x) |>
  filter(upgrade == 2) |>
  filter(version == "baseline")


monthly_changes_elec_x_upgrade_2 <- monthly_changes_elec |>
  filter(bldg_id == bldg_id_x) |>
  filter(upgrade == 2) |>
  filter(version == "baseline")
...
monthly_bills_gas_x_upgrade_0 <- monthly_bills_gas |>
  filter(bldg_id == bldg_id_x) |>
  filter(upgrade == 0) |>
  filter(version == "baseline")

monthly_bills_gas_x_upgrade_2 <- monthly_bills_gas |>
  filter(bldg_id == bldg_id_x) |>
  filter(upgrade == 2) |>
  filter(version == "baseline")

monthly_changes_gas_x_upgrade_2 <- monthly_changes_gas |>
  filter(bldg_id == bldg_id_x) |>
  filter(upgrade == 2) |>
  filter(version == "baseline")
...
```{r}
annual_changes_gas_x_upgrade_2 <- annual_changes_gas |>
  filter(upgrade == 2) |>
  filter(bldg_id == bldg_id_x)
