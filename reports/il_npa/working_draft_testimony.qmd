...
(iii) Replace the single-average cost-per-mile assumption used in this testimony with the **actual cost distribution by project type** under that sequence — addressing PGL's own observation that project costs vary by scope, location, and complexity.[^prp-cost-variation]

[^prp-cost-variation]: Direct Testimony of Polly M. Eldringhoff and Jerry Dickson, NSG-PGL [Ex. 3.0](https://www.icc.illinois.gov/docket/P2026-0065/documents/375324/files/657976.pdf) at 106:2021–2022.
...
While I am not a lawyer, my reading of the Final Order is that the Commission's directive to study NPAs follows two strands of policy logic, even though the Order does not label them as separate motivations.
