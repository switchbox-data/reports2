...
- The **heating season**, which is also called "**winter**" throughout the report, is defined as October through May in Connecticut.
...
::::
59% of homes would cut their wintertime energy bills by switching to heat pumps. That savings would be modest, however: only 16% of homes would see a bill decrease of more than $1,000 per year.
...
On the other hand, many homes in Connecticut today have only partial air conditioning (@fig-bar-cooling-types).
...
Why would (`r annual_change_stats_resistance_baseline_hp_high |> filter(bill_category == "pct_that_lose") |> pull(percentage)`%) of these customers see a small increase in their bills?

We're looking at annual bills here, so these are households that are gaining cooling for the first time, and the increase in their summer bill just manages to offset the savings on their winter bill.
...
@fig-burden_hists_3_smi_tiers_hp_high shows that low-income and moderate-income burdens go up slightly, and the number of highly burdened non-LMI households goes slightly down.
