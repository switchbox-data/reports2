...
n_miles_remaining <- 1112 - n_miles_res - n_miles_mixed
...
plot_data <- data.frame(
  ...
  mutate(
    ...
    text_position = c(0, 150, 1112), #cumsum_miles - miles / 2,
...
ggplot() +
  ...
  scale_y_continuous(limits = c(-250, 1300), expand = c(0, 0)) +
  coord_flip(clip = "off") +
  labs(y = "", x = "") +
  theme(
    axis.line = element_blank(),
...
n_miles_remaining <- 1112 - n_miles_planned
...
plot_data <- data.frame(
  ...
  mutate(
    cumsum_miles = cumsum(miles),
    text_position = c(145, 1112), #cumsum_miles - miles / 2,
    label_text = paste0(label, "\n(", round(miles), " miles)")
  )
...
ggplot() +
  ...
  scale_y_continuous(limits = c(-150, 1300), expand = c(0, 0)) +
  coord_flip(clip = "off") +
  labs(y = "", x = "") +
  theme(
    axis.line = element_blank(),
...
plot_data <- data.frame(
  ...
  mutate(
    cumsum_miles = cumsum(miles),
    text_position = c(1112), #cumsum_miles - miles / 2,
