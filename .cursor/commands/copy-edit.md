---
description: Full professional copy edit of a Quarto report following Chicago Manual of Style (17th ed.) with Switchbox house style
argument-hint: <path-to-qmd-file>
---

# Copy Edit

Perform a thorough copy edit of the specified Quarto report file, the way a professional copy editor working on technical and scientific publications would, grounded in the **Chicago Manual of Style, 17th edition** (CMOS 17) with Switchbox house style overrides noted below.
...
2. The project's `CLAUDE.md` is already in context — it defines Switchbox voice, tone, and writing conventions. The copy edit must not fight those.
