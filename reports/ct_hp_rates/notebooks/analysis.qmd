...
# also throw out any homes that start with a heat pump or "Other/None"
housing_units <- housing_units |>
  filter(baseline_heating_type %in% c("Natural Gas", "Fuel Oil", "Propane", "Electric Resistance"))
...
fig_bill_stacked_bar_gas_on_top <- ggplot(annual_bills_by_component_plot,
  ...
  geom_col() +
  labs(title = "Annual Energy Bills, Before and After Heat Pumps",
       x = "",
       y = "Annual Cost ($)",
       fill = "Charge Type") +
...
#| fig-cap: "The electric bill components and total gas bill for natural gas heated homes, before and after upgrade."
...
ggplot()+
  ...
  labs(
    ...
    y = "Median Monthly Total Bill ($)",
    title = "Median Monthly Total Bill (Electric + Gas)",
    subtitle = "Natural gas-heated homes, before and after upgrade"
  ) +
  theme(
    legend.position = "none",
    panel.grid.major.x = element_blank(),
...
#| fig-cap: "The electric bill components and total fuel oil bill for fuel oil heated homes, before andafter upgrade."
...
ggplot() +
  ...
  labs(
    ...
    y = "Median Monthly Total Bill ($)",
    title = "Median Monthly Total Bill (Electric + Fuel Oil)",
    subtitle = "Fuel oil-heated homes, before and after upgrade"
  ) +
  theme(
    legend.position = "none",
    panel.grid.major.x = element_blank(),
...
annual_bills_elec_by_component <- monthly_bills_elec |>
  ...
  summarize(
    ...
    delivery_charge = sum(delivery_charge),
    customer_charge = sum(customer_charge),
    .by = c(bldg_id, upgrade, version, hvac)
  ) |>
  filter(
    (!(hvac %in% c("hp_low", "hp_high", "hp_best")) & version == "baseline") |
    (hvac == hp_option & version == "baseline")
...
#| fig-cap: "The electric bill components electric resistance-heated homes, before and after upgrade."
...
ggplot()+
  ...
  labs(
    ...
    y = "Median Monthly Total Bill ($)",
    title = "Median Monthly Total Electricity Bill",
    subtitle = "Electric resistance-heated homes, before and after upgrade"
  ) +
  theme(
    legend.position = "none",
    panel.grid.major.x = element_blank(),
...
winter_change_stats_all_fuels_baseline_hp_high <- result[[2]]
...
summer_change_stats_all_fuels_baseline_hp_high <- result[[2]]
...
#| fig-cap: "Proportion of Connecticut homes by primary heating fuel."
#| fig-width: 8
#| fig-height: 2
...
### fig-bar-building-type
```{r}
#| label: fig-bar-building-type
#| fig-cap: "Proportion of Connecticut homes by building type."
#| fig-width: 8
#| fig-height: 2
...
#| fig-cap: "Distribution of annual bill changes for single-family homes switching to heat pumps, all under baseline rates."
...
result <- hist_for_single_rate_version(
  ...
  hvac_option = "hp_high",
  supply_year = supply_year,
  title = "Change in Total Annual Energy Bills for Single-Family Homes in Connecticut\nSwitching to Heat Pumps from All Fuels",
  second_subtitle = "Connecticut",
  x_limits = c(-3000, 3000),
  y_limits = c(0, 300),
  binwidth = 100
...
#| fig-cap: "Distribution of annual bill changes for homes in 2-4 unit multifamily buildings switching to heat pumps, all under baseline rates."
...
result <- hist_for_single_rate_version(
  ...
  hvac_option = "hp_high",
  supply_year = supply_year,
  title = "Change in Total Annual Energy Bills for Connecticut Homes in 2-4 Unit Multifamily Buildings\nSwitching to Heat Pumps from All Fuels",
  second_subtitle = "Connecticut",
  x_limits = c(-3000, 3000),
  y_limits = c(0, 200),
  binwidth = 100
...
#| fig-cap: "Distribution of annual bill changes for homes in 5+ unit multifamily buildings switching to heat pumps, all under baseline rates."
...
result <- hist_for_single_rate_version(
  ...
  hvac_option = "hp_high",
  supply_year = supply_year,
  title = "Change in Total Annual Energy Bills Connecticut Homes in 5+ Unit Multifamily Buildings\nSwitching to Heat Pumps from All Fuels",
  second_subtitle = "Connecticut",
  x_limits = c(-3000, 3000),
  y_limits = c(0, 200),
  binwidth = 100
...
#| fig-cap: "Proportion of Connecticut homes by baseline cooling type."
#| fig-width: 8
#| fig-height: 2
...
result <- hist_for_single_rate_version(
  ...
  hvac_option = "hp_high",
  supply_year = supply_year,
  title = "Change in Total Annual Energy Bills for Connecticut Homes with Room AC\nSwitching to Heat Pumps from All Fuels",
  second_subtitle = "Connecticut",
  x_limits = c(-3000, 3000),
  y_limits = c(0, 300),
  binwidth = 100
...
result <- hist_for_single_rate_version(
  ...
  hvac_option = "hp_high",
  supply_year = supply_year,
  title = "Change in Total Annual Energy Bills for Connecticut Homes with Central AC\nSwitching to Heat Pumps from All Fuels",
  second_subtitle = "Connecticut",
  x_limits = c(-3000, 3000),
  y_limits = c(0, 200),
  binwidth = 100
...
result <- hist_for_single_rate_version(
  ...
  hvac_option = "hp_high",
  supply_year = supply_year,
  title = "Change in Total Annual Energy Bills for Connecticut Homes with No Cooling\nSwitching to Heat Pumps from All Fuels",
  second_subtitle = "Connecticut",
  x_limits = c(-3000, 3000),
  y_limits = c(0, 100),
  binwidth = 100
...
income_threshold_upper <- 1000000
...
#| fig-cap: "Distribution of winter energy burdens in CT, before and after heat pumps"

y_limits <- c(0, 300000/242.13)
...
#| fig-cap: "Proportion of Connecticut homes by dollar tier."
#| fig-width: 8
#| fig-height: 2
...
#| fig-cap: "Proportion of Connecticut homes by State Median Income (SMI) tier. SMI considers both the household's income and the number of occupants in the household."
#| fig-width: 8
#| fig-height: 2
...
burden_hists_moderate_smi_current <- plot_energy_burden_histogram_standalone(
  ...
  filter(
    ...
    version_elec == "baseline",
    hvac == "current"),
  name = "Moderate Income (>60%, <100% SMI)",
  show_x_axis = FALSE,
  show_y_axis = TRUE,
  y_limits = c(0, 50000/242.13),
  x_limits = x_limits
...
burden_hists_not_lmi_current <- plot_energy_burden_histogram_standalone(
  ...
  filter(
    ...
    version_elec == "baseline",
    hvac == "current"),
  name = "Above Median Income (>100% SMI)",
  show_x_axis = TRUE,
  show_y_axis = TRUE,
  y_limits = c(0, 250000/242.13),
  x_limits = x_limits
)
...
burden_hists_3_smi_tiers_current_combined <- burden_hists_low_smi_current_plot / burden_hists_moderate_smi_current_plot / burden_hists_not_lmi_current_plot +
  ...
  plot_annotation(
    title = "Annual Energy Burdens for 3 Income Tiers in Connecticut: Current HVAC",
    #subtitle = paste0("Among households of annual income <", scales::dollar(income_threshold_upper)),
    theme = theme(
      plot.title = element_text(hjust = 0.5, size = 9, face = "bold"),
      plot.subtitle = element_text(hjust = 0.5, size = 8),
...
burden_hists_3_smi_tiers_hp_high_combined <- burden_hists_low_smi_hp_high_plot / burden_hists_moderate_smi_hp_high_plot / burden_hists_not_lmi_hp_high_plot +
  ...
  plot_annotation(
    title = "Annual Energy Burdens for 3 Income Tiers in Connecticut: Cold Climate Heat Pump",
    #subtitle = paste0("Among households of annual income <", scales::dollar(income_threshold_upper)),
    theme = theme(
      plot.title = element_text(hjust = 0.5, size = 9, face = "bold"),
      plot.subtitle = element_text(hjust = 0.5, size = 8),
...
result <- hist_for_single_rate_version(
  ...
  hvac_option = "hp_low",
  supply_year = supply_year,
  title = "Change in Total Annual Energy Bills for Homes with Low Income \nSwitching to Heat Pumps from All Fuels",
  second_subtitle = "Connecticut",
  x_limits = c(-3000, 3000),
  y_limits = c(0, 600),
  binwidth = 100
...
save(
  ...
  # all fuels
  winter_change_stats_all_fuels_baseline_hp_high,
  summer_change_stats_all_fuels_baseline_hp_high,
