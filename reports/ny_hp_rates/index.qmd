...
Rates can be more or less cost-aligned: a perfectly cost-aligned delivery rate would bill _every_ customer exactly their cost-of-service for delivery. Our proposed seasonal delivery rate is cost-aligned _on average_ for heat pump customers, because it lowers their volumetric rate in winter to a level that causes their average delivery bill to equal their average cost-of-service.[^cost-causal-rate]

**Economic efficiency** is achieved through **cost-reflective rates**, defined as a rate that exposes customers to prices that reflect the underlying costs of energy and infrastructure, which change over time and by location.[^cost-reflective-rate]

[^cost-causal-rate]: Individual HP customers may still over or underpay relative to their cost-of-service, though less than under current default rates.

Rates can be more or less cost-reflective: a perfectly cost-reflective rate would expose customers to different volumetric prices for energy and infrastructure, at every address, every five minutes, in order to collect _marginal_ energy and capacity costs. And it would collect _residual_ capacity costs through a non-volumetric price, like a fixed or demand charge, so as not to distort the time-and-location-dependent cost signals.

In practice,

[^cost-reflective-rate]: A perfectly cost-reflective rate would expose customers to different volumetric prices for energy and infrastructure, at every address, every five minutes, in order to collect _marginal_ energy and capacity costs. It would collect _residual_ capacity costs through a non-volumetric price like a fixed or demand charge, so as not to distort the time-and-location-dependent cost signals.

A rate can be cost-causal without being cost-reflective: consider a fixed charge, unique to each customer, perfectly tailored to recover their cost-of-service. A customer's bill would charge them for the marginal energy and capacity costs they incurred that month, due to their hour-by-hour usage, along with their share of residual capacity costs. However, it would


  - Time-varying rates achieve these **energy** and **capacity investment deferral** benefits by making electricity
    bills more **cost-reflective**, in the sense that they expose customers to electricity prices that more closely reflect the underlying cost of generating electricity (also known as marginal energy costs) and expanding grid capacity (also known as marginal capacity costs).
...
#| echo: false
#| output: asis
print(Path("cache/tou_rate_table.html").read_text())
```
:::::
