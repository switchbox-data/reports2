...
::::: {.column-page-inset-right}
{{< embed notebooks/analysis.qmd#fig-quadrant-bar-fossil-ehrate-state >}}
:::::

- ER → HP switching economics: `{python} pct(v.pct_elec_resistance_save_hprate)` save under default → HP-seasonal (average `{python} dollar(v.mean_er_switch_delta_hprate)`/yr) vs. `{python} pct(v.pct_er_switch_save_ehrate)` save under EH → EH (average `{python} dollar(v.mean_er_switch_delta_ehrate)`/yr).

::::: {.column-page-inset-right}
{{< embed notebooks/analysis.qmd#fig-quadrant-bar-elec-resistance-switch-ehrate-vs-hprate-state >}}
:::::
