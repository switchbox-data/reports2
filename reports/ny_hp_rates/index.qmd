...
The seasonal design mirrors the one we used for the heat pump-only rate: the summer volumetric rate matches the current default rate — so no electric heating customer pays more in summer than they do today — and the winter rate is lowered enough to bring electric heating customers' annual delivery revenue in line with their combined cost of service.
...
In other words, this rate would fix the fairness problem that affects all electric heating customers in New York State. What would that mean for their bills?
...
This is an overdue correction of a long-standing overcharge. Electric resistance customers have been overpaying for delivery for decades — not because they cause disproportionately high capacity costs, but because flat volumetric delivery rates overcharge any customer who uses more electricity than average. Enrolling them in the electric heating rate fixes that.
...
As with the heat pump-only rate, this is not a rate hike. It is the removal of a cross-subsidy that gas, oil, and propane customers have been receiving for years from their electric-heating neighbors — a cross-subsidy that runs directly against New York's own policy of electrifying buildings. Extending the seasonal rate to all electric heating customers ends that cross-subsidy in full, rather than removing just the portion attributable to heat pump customers.
