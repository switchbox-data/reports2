...
The picture sharpens when we zoom in to individual utilities. Each chart overlays summer (faded) and winter (solid) peak growth components — excluding large loads, which connect at substations rather than feeders. A fine gray dotted line traces where the summer peak goes after winter eclipses it. A dashed line marks the distribution-relevant crossover year, and a red dashed line marks the year that distribution headroom is exhausted, based on the Synapse Energy Economics (2024) assessment of each utility's spare distribution capacity.
