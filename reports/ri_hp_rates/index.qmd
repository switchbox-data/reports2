...
This causes the overall bill to grow by `r (post_hp_total_bill_gas / pre_hp_total_bill_gas) |> scales::percent()`, to `r post_hp_total_bill_gas |> scales::dollar(accuracy = 1)`.
