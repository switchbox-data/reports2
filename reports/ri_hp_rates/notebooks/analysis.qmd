...
```{r}
path_metadata_upgrade2 = "data/ResStock/2024_release2_tmy3/metadata/RI_upgrade02_metadata_and_annual_results.parquet"
metadata_upgrade2 <- read_parquet(path_metadata_upgrade2) |>
filter(in.state == "RI")
