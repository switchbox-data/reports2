...
#| fig-cap: 'Historical and forecasted LEA subsidy costs per connection for Nicor Gas. Note that the service line estimates are based on the average reported "per project" cost, which we interpret to mean connections. Costs may reflect both residential and non-residential connections.'
...
#| fig-cap: "Historical LEA subsidy costs per connection of single new residential single-family homes for Peoples Gas"
...
#| fig-cap: "Historical standard cost equivalent per connection for Ameren Gas"
lea_df |>
  filter(utility == "ameren") |>
...
data_avail <- tribble(
  ...
  # Nicor Forecast
  "Nicor Gas", "Forecast",
  "2023-2029|green", "2023-2029|green", "red", "red", "2023-2026|yellow", "red", "2023-2026|green", "2023-2026|green",
  # Ameren Historical
...
gt_table <- data_display |>
  ...
  tab_source_note(
    source_note = "Nicor 2027–2029 figures are combined-only (from ICC Docket 25-0055); service/main breakdown is available only through 2026 (from ICC Docket 23-0066)."
  )
