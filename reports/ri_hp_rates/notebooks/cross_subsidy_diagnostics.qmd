...
cross_summary_all[["run_label", "group", "customers_weighted"]].sort_values(
    ["run_label", "group"]
...
per_customer_long = (
    ...
    .melt(
        ...
        value_vars=list(_residual_cols.keys()),
        var_name="residual_key",
        value_name="residual_usd_per_customer",
    )
    .assign(benchmark=lambda d: d["residual_key"].map(_residual_cols))
    .melt(
        id_vars=["run_label", "group", "benchmark"],
        value_vars=["Economic_burden_weighted_avg", "residual_usd_per_customer"],
...
(
    ggplot(per_customer_long, aes(x="group", y="usd_per_customer", fill="cost_source"))
