...
Under fair rates, the Buffalo home's annual energy bill after switching to a heat pump would drop by **`{python} f"{v.fair_rate_savings_pct * 100:.0f}"`%** — from `{python} dollar(v.fair_rate_total_bill + v.fair_rate_savings_dollar)` to **`{python} dollar(v.fair_rate_total_bill)`**.
